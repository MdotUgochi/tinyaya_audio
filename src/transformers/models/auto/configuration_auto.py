...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("pvt_v2", "PvtV2Config"),
        ("qwen2", "Qwen2Config"),
        ("tinyaya_audio_encoder", "TinyAyaAudioEncoderConfig"),
        ("tinyaya_audio", "TinyAyaAudioConfig"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("tinyaya_audio", "TinyAyaAudio"),
        ("tinyaya_audio_encoder", "TinyAyaAudioEncoder"),
...
SPECIAL_MODEL_TYPE_TO_MODULE_NAME = OrderedDict[str, str](
    [
        ...
        ("tinyaya_audio", "tinyaya_audio"),
        ("tinyaya_audio_encoder", "tinyaya_audio"),
